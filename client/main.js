...
Template.editor.helpers({
  ...
  Template.editingUsers.helpers({
    users: function(){
      ...
      if(!eusers){return;} // no editing users

      users = new Array();
      var i = 0;
      for (var usr_id in eusers.users){
        users[i] = fixObjectKeys(eusers.users[usr_id]);
        i++;
      }
      return users;
    }
  ...
  Template.navbar.events({
    "click .js-add-doc": function(event){
      ...
      if(!Meteor.user()){
        ...
        // users is logged in, add a document
    ...
    "click .js-load-doc": function(event){
      console.log("the clicked document: ", this);
